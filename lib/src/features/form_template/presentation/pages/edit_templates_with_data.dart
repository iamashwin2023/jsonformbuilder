...
// class EditTemplateDataPage extends StatefulWidget {
//   final DataRecordResponseModel template;
//   const EditTemplateDataPage({super.key, required this.template});

//   @override
//   State<EditTemplateDataPage> createState() => _EditTemplateDataPageState();
// }

// class _EditTemplateDataPageState extends State<EditTemplateDataPage> {
...
//     jsonData = widget.template.inputData.toString();
...
//     return Scaffold(
//       appBar: AppBar(
//         title: Text(widget.template.id.toString()),
//       ),
//       body: Center(
//         child:
...
//   Widget _buildForm(
//       DataRecordResponseModel template, DataSourceProvider dataSourceProvider) {
...
//                                         templateWithData: widget.template),
//                               ),
//                             );
//                           },
//                           child: Text('Preview'),
...
//             //  panNumber: _selectedType == 'PanNumberField' ? _panNumber : null,
